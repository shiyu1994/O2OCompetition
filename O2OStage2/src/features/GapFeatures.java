...
public class GapFeatures {
	private static Boolean onlineOrOffline = false;
	
	public static class GapFeaturesMapper extends MapperBase {
		private Record key;
	...
	public static class GapFeaturesReducer extends ReducerBase { 
		private Record counts;
		...
		public void reduce(Record key, Iterator<Record> values, TaskContext context) throws IOException {
			...
			for(int i = 0; i < allReceivedDate.size(); ++i) {
				...
				//	continue;
				//} 
				if(i < allReceivedDate.size() - 1 && allReceivedDate.get(i).equals(dateString)) {
					continue;	
				}
	...
	public static void main(String[] args) throws OdpsException {
		...
		job.setMapperClass(GapFeaturesMapper.class);
		job.setReducerClass(GapFeaturesReducer.class);
