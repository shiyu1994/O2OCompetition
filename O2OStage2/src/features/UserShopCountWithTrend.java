...
public class UserShopCountWithTrend {
	...
	public static class Reducer extends ReducerBase {
		...
		public void reduce(Record key, Iterator<Record> values, TaskContext context) throws IOException {
			...
			counts.set(14, calcTrend(unusedCouponList, n));
			counts.set(15, calcTrend(buyWithoutCouponList, n));
			counts.set(16, calcTrend(usedCouponList, n));
			...
			counts.set(17, calcTrend(totalCouponList, n));
			...
			counts.set(18, calcTrend(totalBuyList, n));
			...
			counts.set(19, calcTrend(act0RatioList, n));
			...
			counts.set(20, calcTrend(act1RatioList, n));
			...
			counts.set(22, calcTrend(usedCouponRatioList, n));
			...
			counts.set(23, calcTrend(buyWithCouponRatioList, n)); 
