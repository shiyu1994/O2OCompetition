...
public class UserShopCount {
	private static Boolean onlineOrOffline = false;
	
	public static class UserShopMonthCountMapper extends MapperBase {
		private Record key;
	...
	public static class UserShopMonthCountReducer extends ReducerBase {
		private Record counts;
	...
	public static void main(String[] args) throws OdpsException {
		...
		job.setMapperClass(UserShopMonthCountMapper.class);
		job.setReducerClass(UserShopMonthCountReducer.class);
