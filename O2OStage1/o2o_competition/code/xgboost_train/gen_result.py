...
path = '/Users/shiyu/Projects/o2o_competition/ccf_data_revised/'
path_features = '/Users/shiyu/Projects/o2o_competition/my_data/'
...
def gen():
    ...
    np.savetxt(path_features + 'submit_11_1_24.csv', result, delimiter=',', fmt="%d,%d,%d,%10.20f")
